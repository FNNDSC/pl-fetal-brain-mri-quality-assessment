...
http://patorjk.com/software/taag/#p=display&f=Doom&t=fetal_brain_quality_assessment
...
where necessary.)
    ...
    NAME
       ...
       fetal_brain_quality_assessment.py 

    SYNOPSIS

        python fetal_brain_quality_assessment.py                                         \\
            [-h] [--help]                                               \\
            [--json]                                                    \\
            [--man]                                                     \\
            [--meta]                                                    \\
    ...
    BRIEF EXAMPLE
        ...
        * Bare bones execution
            ...
            docker run --rm -u $(id -u)                             \
                ...
                fnndsc/pl-fetal-brain-quality-assessment fetal_brain_quality_assessment                        \
                /incoming /outgoing
